...
describe('User API Test', function(){
  ...
  it('Create a user - POST', function(done){
    request
      .post('http://localhost:3000/app/audit')
      .send({
        UserId:       "Work",
        Collection:   "te44s123333t",
        Operation:    "te44am331231po2@gmail.com",
        PrevState:    "te44am331231po2@gmail.com",
        NewState:     "te44am331231po2@gmail.com",
      })
  ...
  it('Get it back again - GET ' + dbid, function(done){
    request
     .get('http://localhost:3000/app/audit/:id')
  ...
  */
  ...
  it('Modify a user - PUT '+dbid, function(done){
    request
      .put('http://localhost:3000/app/audit/:id')
      .send({
        //isactive:     true,
       // issysadmin:   true
      })
  ...
  it('Delete it - DEL ' + dbid, function (done) {
      request
        .del('http://localhost:3000/app/audit/:id')
        .end(function (res) {
            res.statusCode.should.equal(200);
            res.body.success.should.equal(true);
            done();
