...
describe('User API Test', function(){
  ...
  it('Create a user - POST', function(done){
    request
      .post('http://localhost:3000/app/address')
      .send({
        Type:       "Work",
        Address1:   "te44s123333t",
        Address2:   "te44am331231po2@gmail.com",
        Suburb:     "te44am331231po2@gmail.com",
        Postcode:   "te44am331231po2@gmail.com",
        State:      "",
        Country:    "",
        Phone:      "",
  ...
  it('Get it back again - GET ' + dbid, function(done){
    request
     .get('http://localhost:3000/app/address/')
  ...
  */
  ...
  it('Modify a user - PUT '+dbid, function(done){
    request
      .put('http://localhost:3000/app/address/:id')
      .send({
        //isactive:     true,
       // issysadmin:   true
      })
  ...
  it('Delete it - DEL ' + dbid, function (done) {
      request
        .del('http://localhost:3000/app/address/:id')
        .end(function (res) {
            res.statusCode.should.equal(200);
            res.body.success.should.equal(true);
            done();
