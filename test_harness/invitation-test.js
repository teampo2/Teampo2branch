...
describe('User API Test', function(){
  ...
  it('Create a user - POST', function(done){
    request
      ...
      .send({
      //  OrgId:       "Work",
       // SenderId:   "te44s123333t",
       // RecipientId:   "te44am331231po2@gmail.com",
        Status:     "te44am331231po2@gmail.com",
        Type:   "te44am331231po2@gmail.com",
        Message:      "",
  ...
  it('Get it back again - GET ' + dbid, function(done){
    request
     .get('http://localhost:3000/app/services/')
