...
describe('User API Test', function(){
  ...
  it('Create a user - POST', function(done){
    request
      .post('http://localhost:3000/app/services')
      .send({
        Type:       "Work",
        SystemName:   "te44s123333t",
        ServiceName:   "te44am331231po2@gmail.com",
        ServiceVersion:     "te44am331231po2@gmail.com",
        ServiceURL:   "te44am331231po2@gmail.com",
  ...
  it('Get it back again - GET ' + dbid, function(done){
    request
     .get('http://localhost:3000/app/services/:id')
  ...
  */
  ...
  it('Modify a user - PUT '+dbid, function(done){
    request
      .put('http://localhost:3000/app/services/:id')
      .send({
        //isactive:     true,
       // issysadmin:   true
      })
